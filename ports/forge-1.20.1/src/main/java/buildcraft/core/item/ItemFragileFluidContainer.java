...
public class ItemFragileFluidContainer extends Item implements IItemFluidShard {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (fluidTag != null) {
            FluidStack fluid = LegacyFluidCompat.loadFluidStackFromNBT(fluidTag);
            if (!fluid.isEmpty()) {
    ...
    public static FluidStack getFluid(ItemStack container) {
        ...
        return fluidNbt == null ? FluidStack.EMPTY : LegacyFluidCompat.loadFluidStackFromNBT(fluidNbt);
    }
