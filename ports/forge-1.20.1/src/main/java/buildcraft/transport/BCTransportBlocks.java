...
public class BCTransportBlocks {
    ...
    public static final RegistryObject<BlockEntityType<TileFilteredBuffer>> FILTERREDBUFFER_BE = BET.register("filtered_buffer",
    		() -> BlockEntityType.Builder.of(TileFilteredBuffer::new, filterBuffer.get()).build(null));
    public static final RegistryObject<BlockEntityType<TilePipeHolder>> PIPE_HOLDER_BE = BET.register("pipe_holder",
