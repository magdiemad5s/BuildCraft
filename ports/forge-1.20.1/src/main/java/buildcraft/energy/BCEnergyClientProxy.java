...
public abstract class BCEnergyClientProxy {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(BCEnergyGuis.MENU_RF.get(), GuiEngineRF::new);
            MenuScreens.register(BCEnergyGuis.DYNAMO_MJ.get(), GuiDynamoMJ::new);
        });
    }
    ...
    public static void registryRender(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(BCEnergyBlocks.ENGINE_RF_TILE.get(), RenderEngine_BC8::new);
