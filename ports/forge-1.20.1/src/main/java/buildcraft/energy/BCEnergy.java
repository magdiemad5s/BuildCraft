...
public class BCEnergy {
    ...
    public BCEnergy() {
        ...
        BCEnergyConfig.registry(modEventBus);

        BCCore.BUILDCRAFT_TAB.addItemProvider(BCEnergyBlocks::getCreativeTabItems);
        BCCore.BUILDCRAFT_TAB.addItemProvider(BCEnergyItems::getCreativeTabItems);
    ...
    public void gatherData(GatherDataEvent event) {
        ...
        event.getGenerator().addProvider(
            event.includeServer(),
            buildcraft.lib.data.NamedDataProvider.of("BuildCraft Energy Recipes",
                new BCEnergyRecipes.BCEnergyRecipeProvider(output))
        );
