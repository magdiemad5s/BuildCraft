...
public class TileZonePlanner extends TileBC_Neptune implements IDebuggable, MenuProvider {
    ...
    public void setMapName(String mapName) {
        this.mapName = ZoneMapRequestPolicy.sanitizeMapName(mapName);
        setChanged();
    }
    ...
    public void writePayload(int id, FriendlyByteBuf buffer, LogicalSide side) {
        ...
        if (side == LogicalSide.SERVER && id == NET_RENDER_DATA) {
            buffer.writeUtf(mapName, ZoneMapRequestPolicy.MAX_MAP_NAME_LENGTH);
    ...
    public void readPayload(int id, FriendlyByteBuf buffer, LogicalSide side, NetworkEvent.Context ctx) throws IOException {
        ...
        if (side == LogicalSide.CLIENT && id == NET_RENDER_DATA) {
            mapName = ZoneMapRequestPolicy.sanitizeMapName(
    ...
    public void load(CompoundTag nbt) {
        ...
        mapName = ZoneMapRequestPolicy.sanitizeMapName(nbt.getString("name"));
