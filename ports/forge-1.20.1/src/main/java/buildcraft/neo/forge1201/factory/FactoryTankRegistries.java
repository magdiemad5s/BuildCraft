 ...
 *
 * <p>This uses Forge's register event because the inherited legacy scaffold has
 * already constructed its module entry point. It keeps registration in the
 * {@code buildcraftfactory} namespace without mutating the legacy checkout.</p>
 */
