...
public class GuiGate extends GuiBC8<ContainerGate> {
    ...
    public void containerTick() {
        ...
        if (!container.isValidGateMenu()) {
            if (minecraft.player != null && minecraft.player.containerMenu == container) {
                minecraft.player.closeContainer();
            }
            return;
        }
        if (!requestedValidStatements
            && minecraft.player != null
            && minecraft.player.containerMenu == container) {
            requestedValidStatements = true;
            container.requestValidStatements();
        }
    }
