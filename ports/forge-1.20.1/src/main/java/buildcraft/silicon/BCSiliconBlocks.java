...
public class BCSiliconBlocks {
    ...
    public static final RegistryObject<BlockEntityType<TileLaser>> LASER_TILE = BLOCK_ENTITYS.register("laser", 
    		() -> BlockEntityType.Builder.of(TileLaser::new,LASER_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileAssemblyTable>> ASSEMBLY_TABLE_TILE = BLOCK_ENTITYS.register("assembly_table", 
    		() -> BlockEntityType.Builder.of(TileAssemblyTable::new,ASSEMBLY_TABLE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileChargingTable>> CHARGING_TABLE_TILE = BLOCK_ENTITYS.register("charging_table", 
    		() -> BlockEntityType.Builder.of(TileChargingTable::new,CHARGING_TABLE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileIntegrationTable>> INTERGRATION_TABLE_TILE = BLOCK_ENTITYS.register("integration_table", 
    		() -> BlockEntityType.Builder.of(TileIntegrationTable::new,INTERGRATION_TABLE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileAdvancedCraftingTable>> ADVANCED_CRAFTING_TABLE_TILE = BLOCK_ENTITYS.register("advanced_crafting_table", 
    		() -> BlockEntityType.Builder.of(TileAdvancedCraftingTable::new,ADVANCED_CRAFTING_TABLE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileProgrammingTable_Neptune>> PROGRAMMING_TABLE_TILE = BLOCK_ENTITYS.register("programming_table", 
