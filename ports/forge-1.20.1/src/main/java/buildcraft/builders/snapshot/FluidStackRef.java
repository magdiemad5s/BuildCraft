...
public class FluidStackRef {
    ...
    public FluidStack get(Tag nbt) {
        return new FluidStack(
            Objects.requireNonNull(
                ForgeRegistries.FLUIDS.getValue(resolvePersistedFluidId(
                    fluid
                        .get(nbt)
    ...
    static ResourceLocation resolvePersistedFluidId(String persistedName) {
        return LegacyFluidCompat.resolveFluidIdForLoad(persistedName);
    }
}
