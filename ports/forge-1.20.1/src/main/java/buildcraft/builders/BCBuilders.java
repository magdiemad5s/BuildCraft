...
//    	modEventBus.addListener(this::gatherData);//DataGenerator
        ...
        MessageManager.registerMessageClass(BCModules.BUILDERS, MessageSnapshotRequest.class, MessageSnapshotRequest.HANDLER, MessageSnapshotRequest::toBytes, MessageSnapshotRequest::new, Dist.DEDICATED_SERVER);
        MessageManager.registerMessageClass(BCModules.BUILDERS, MessageSnapshotResponse.class, MessageSnapshotResponse.HANDLER, MessageSnapshotResponse::toBytes, MessageSnapshotResponse::new, Dist.CLIENT);
    ...
    public void serverStarting(ServerStartingEvent event) {
        GlobalSavedDataSnapshots.reInit(LogicalSide.SERVER);
    }
