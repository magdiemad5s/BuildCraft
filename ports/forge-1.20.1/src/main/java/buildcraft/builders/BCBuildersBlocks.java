...
public class BCBuildersBlocks {
    ...
    public static final RegistryObject<BlockEntityType<TileFiller>> FILLER_TILE_BC8 = BLOCK_ENTITYS.register("filler", 
    		() -> BlockEntityType.Builder.of(TileFiller::new, FILLER.get()).build(null));
    
    public static final RegistryObject<BlockEntityType<TileBuilder>> BUILDER_TILE_BC8 = BLOCK_ENTITYS.register("builder", 
    		() -> BlockEntityType.Builder.of(TileBuilder::new, BUILDER.get()).build(null));
    
    public static final RegistryObject<BlockEntityType<TileArchitectTable>> ARCHITECT_TILE_BC8 = BLOCK_ENTITYS.register("architect", 
    		() -> BlockEntityType.Builder.of(TileArchitectTable::new, ARCHITECT.get()).build(null));
    
    public static final RegistryObject<BlockEntityType<TileElectronicLibrary>> LIBRARY_TILE_BC8 = BLOCK_ENTITYS.register("library", 
    		() -> BlockEntityType.Builder.of(TileElectronicLibrary::new, LIBRARY.get()).build(null));
    
    public static final RegistryObject<BlockEntityType<TileReplacer>> REPLACER_TILE_BC8 = BLOCK_ENTITYS.register("replacer", 
    ...
    public static final RegistryObject<BlockEntityType<TileQuarry>> QUARRY_TILE_BC8 = BLOCK_ENTITYS.register("quarry", 
