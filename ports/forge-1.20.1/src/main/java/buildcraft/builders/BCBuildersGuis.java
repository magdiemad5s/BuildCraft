...
public class BCBuildersGuis {
    ...
    public static final RegistryObject<MenuType<ContainerFillerPlanner>> MENU_FILLER_PLANNER = MENUS.register(
        ContainerFillerPlanner.MENU_ID_PATH,
        () -> BCContainerFactory.create(ContainerFillerPlanner::new)
    );
