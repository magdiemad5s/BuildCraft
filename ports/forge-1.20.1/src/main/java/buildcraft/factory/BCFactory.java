...
public class BCFactory {
    ...
    public void gatherData(GatherDataEvent event) {
        event.getGenerator().addProvider(
            ...
            buildcraft.lib.data.NamedDataProvider.of(
                "BuildCraft Factory Recipes",
                new BCFactoryRecipesProvider(event.getGenerator().getPackOutput())
            )
        );
    }
    ...
    private static void validateNetworkIds() {
        ...
        int gasOutput = TileDistiller_BC8.NET_TANK_GAS_OUT;
        int input = TileDistiller_BC8.NET_TANK_IN;
        int liquidOutput = TileDistiller_BC8.NET_TANK_LIQUID_OUT;
    }
