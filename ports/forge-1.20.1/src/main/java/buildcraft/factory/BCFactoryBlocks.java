...
public class BCFactoryBlocks {
    ...
    public static final RegistryObject<BlockEntityType<TileTank>> ENTITYBLOCKTANK = BLOCK_ENTITYS.register("tank", 
    		() -> BlockEntityType.Builder.of(TileTank::new,TANK_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TilePump>> ENTITYBLOCKPUMP = BLOCK_ENTITYS.register("pump",
...
//    		() -> BlockEntityType.Builder.of(EntityBlockTube::new,TUBE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileFloodGate>> ENTITYBLOCKFLOODGATE = BLOCK_ENTITYS.register("flood_gate",
    		() -> BlockEntityType.Builder.of(TileFloodGate::new,FLOOD_GATE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileMiningWell>> ENTITYBLOCKMININGWELL = BLOCK_ENTITYS.register("mining_well",
    		() -> BlockEntityType.Builder.of(TileMiningWell::new,MINING_WELL_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileDistiller_BC8>> ENTITYBLOCKDISTILLER = BLOCK_ENTITYS.register("distiller", 
    		() -> BlockEntityType.Builder.of(TileDistiller_BC8::new, DISTILLER_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileHeatExchange>> ENTITYBLOCKHEATEXCHANGE = BLOCK_ENTITYS.register("heat_exchange", 
    		() -> BlockEntityType.Builder.of(TileHeatExchange::new, HEATEXCHANGE_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileAutoWorkbenchItems>> ENTITYBLOCKAUTOBENCH = BLOCK_ENTITYS.register("autoworkbench_item", 
    		() -> BlockEntityType.Builder.of(TileAutoWorkbenchItems::new, AUTO_BENCH_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileChute>> ENTITYBLOCKCHUTE = BLOCK_ENTITYS.register("chute", 
