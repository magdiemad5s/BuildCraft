...
public class BCFactoryGuis {
    ...
    public static final RegistryObject<MenuType<ContainerDistiller>> MENU_DISTILLER = MENUS.register(
        DistillerMenuStatePolicy.MENU_REGISTRY_PATH,
        () -> BCContainerFactory.create(ContainerDistiller::new)
    );
