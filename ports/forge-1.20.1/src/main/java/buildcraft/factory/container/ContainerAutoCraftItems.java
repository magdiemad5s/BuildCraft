...
public class ContainerAutoCraftItems extends ContainerBCTile<TileAutoWorkbenchItems> {
    ...
    public final SlotBase[] filterSlots;
    /** @deprecated Misspelled compatibility alias retained for older port code. */
    @Deprecated
    public final SlotBase[] filtterSlots;
    public final IItemHandlerAdv blueprintHandler;
    ...
    public ContainerAutoCraftItems(int containerId, Inventory player, IItemHandlerAdv invResult, IItemHandlerAdv invBlueprint, 
        ...
        filterSlots = new SlotBase[9];
        filtterSlots = filterSlots;
        for (int x = 0; x < 9; x++) {
            // hide the filter slots, but still sync them
        	addSlot(filterSlots[x] = new SlotPhantom(invMaterialFilter, x, -1000000, -1000000));
